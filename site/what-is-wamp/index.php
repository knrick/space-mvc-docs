...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0, mkdocs-material-3.1.0">
        ...
        <title>What is Wamp? - Space MVC Framework</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="#what-does-wamp-mean" tabindex="1" class="md-skip">
        Skip to content
      </a>
...
<div class="md-search" data-md-component="search" role="dialog">
  ...
  <li class="md-nav__item md-nav__item--active">
    ...
    <a href="./" title="What is Wamp?" class="md-nav__link md-nav__link--active">
      What is Wamp?
    </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#what-is-the-wamp-server-application" title="What is the Wamp Server Application?" class="md-nav__link">
    What is the Wamp Server Application?
        ...
        <li class="md-nav__item">
  <a href="#how-to-install-the-wamp-server-application" title="How to Install the Wamp Server Application?" class="md-nav__link">
    ...
    How to Install the Wamp Server Application?
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
              ...
              <!-- 
                  <a href="https://github.com/space-mvc/space-mvc/edit/master/docs/what-is-wamp.md" title="Edit this page" class="md-icon md-content__icon">&#xE3C9;</a>
                 -->

                
                <h1 id="what-does-wamp-mean">What does Wamp mean?</h1>
<p>WAMP is sometimes used as an abbreviated name for the software stack Windows, Apache, MySQL, PHP. It is derived from LAMP which stands for Linux, Apache, MySQL, and PHP. As the name implies, while LAMP is used on Linux servers, WAMP is used on Windows servers.</p>
<p>The Apple OSX abbreviation is MAMP for Mac, Apache, Mysql and PHP.</p>
<p>The "A" in WAMP stands for Apache. Apache is server software that is used to serve webpages. Whenever someone types in your website’s URL, Apache is the software that "serves" your website.</p>
<p>The "M" in WAMP stands for MySQL. MySQL is a database management system. It’s job in the software stack is to store all of your website’s content, user profiles, comments, etc.</p>
<p>The "P" in WAMP stands for PHP. PHP is the programming language that Space MVC is written in. It is also the piece that holds the entire software stack together. It runs as a process in Apache and communicates with the MySQL database to dynamically build your webpages.</p>
<p>WAMP software stack can be downloaded from wampserver project’s download page.</p>
<h2 id="what-is-the-wamp-server-application">What is the Wamp Server Application?</h2>
...
<h2 id="how-to-install-the-wamp-server-application">How to Install the Wamp Server Application?</h2>
...
<footer class="md-footer" style="position:fixed;bottom:0;left:0;width:100%;">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../what-is-php-storm/" title="What is PHP Storm IDE?" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
