...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0, mkdocs-material-3.1.0">
        ...
        <title>Configuration - Space MVC Framework</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="#database-configuration" tabindex="1" class="md-skip">
        Skip to content
      </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#database-configuration" title="Database : Configuration" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#multi-connections" title="Multi-connections" class="md-nav__link">
    Multi-connections
  </a>
        ...
        <li class="md-nav__item">
  <a href="#setting-the-encoding" title="Setting the encoding" class="md-nav__link">
    ...
    Setting the encoding
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
              ...
              <!-- 
                  <a href="https://github.com/space-mvc/space-mvc/edit/master/docs/database-configuration.md" title="Edit this page" class="md-icon md-content__icon">&#xE3C9;</a>
                 -->
...
<p>Setup is very easy and straight-forward. There are essentially only two configuration points you must concern yourself with:
<ol>
...
<pre><code class="php"> 1 # inclue the ActiveRecord library
...
<pre><code class="php">1 $cfg = ActiveRecord\Config::instance();
...
<pre><code>&lt;h4 id="default-connections"&gt;Default connection
</code></pre>
...
<pre><code class="php"> 1 $connections = array(
...
<pre><code class="php"> 1 # SomeOciModel.php
...
<pre><code class="php"> 1 # OciModels.php
...
<h2 id="setting-the-encoding">Setting the encoding</h2>
<p>The character encoding can be specified in your connection parameters:</p>
<pre><code class="php">1 $config-&gt;set_connections(array(
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../database-getting-started/" title="Getting Started" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
          ...
          <a href="../database-conventions/" title="Conventions" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
