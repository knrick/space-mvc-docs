...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0, mkdocs-material-3.1.0">
        ...
        <title>Controllers - Space MVC Framework</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="#controllers" tabindex="1" class="md-skip">
        Skip to content
      </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#defining-controllers" title="Defining Controllers" class="md-nav__link">
    Defining Controllers
        ...
        <li class="md-nav__item">
  <a href="#controllers-namespaces" title="Controllers &amp; Namespaces" class="md-nav__link">
    ...
    Controllers &amp; Namespaces
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
              ...
              <!-- 
                  <a href="https://github.com/space-mvc/space-mvc/edit/master/docs/controllers.md" title="Edit this page" class="md-icon md-content__icon">&#xE3C9;</a>
                 -->
...
<pre><code class="php">Route::get('user/{id}', 'UserController@show');
</code></pre>

<p>Now, when a request matches the specified route URI, the show method on the UserController class will be executed. Of course, the route parameters will also be passed to the method.
...
<a name="controllers-and-namespaces"></a></p>
<h3 id="controllers-namespaces">Controllers &amp; Namespaces</h3>
...
If you choose to nest your controllers deeper into the App\Http\Controllers directory, use the specific class name relative to the App\Http\Controllers root namespace. So, if your full controller class is App\Http\Controllers\Photos\AdminController, you should register routes to the controller like so:</p>
<pre><code class="php">Route::get('foo', 'Photos\AdminController@method');
</code></pre>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../requests/" title="Requests" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
