...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0, mkdocs-material-3.1.0">
        ...
        <title>How to use git in a Dev Team? - Space MVC Framework</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="#how-do-multiple-developers-use-git" tabindex="1" class="md-skip">
        Skip to content
      </a>
...
<div class="md-search" data-md-component="search" role="dialog">
  ...
  <li class="md-nav__item md-nav__item--active">
    ...
    <a href="./" title="How to use git in a Dev Team?" class="md-nav__link md-nav__link--active">
      How to use git in a Dev Team?
    </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#how-do-developers-work-in-a-team-using-git" title="How do developers work in a team using git?" class="md-nav__link">
    How do developers work in a team using git?
        ...
        <li class="md-nav__item">
  <a href="#general-git-commands" title="General Git Commands" class="md-nav__link">
    ...
    General Git Commands
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
              ...
              <!-- 
                  <a href="https://github.com/space-mvc/space-mvc/edit/master/docs/github-multiple-users.md" title="Edit this page" class="md-icon md-content__icon">&#xE3C9;</a>
                 -->

                
                <h1 id="how-do-multiple-developers-use-git">How do multiple developers use git?</h1>
...
<h2 id="how-do-developers-work-in-a-team-using-git">How do developers work in a team using git?</h2>
...
<h2 id="general-git-commands">General Git Commands</h2>
<p>These are the general git commands. Below it shows how to use them on the command line
If you use source tree the buttons across the top menu in source tree can run these command actions for you</p>
<table>
<thead>
<tr>
<th>Command</th>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../what-is-git/" title="What is Git?" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
          ...
          <a href="../download-space-mvc/" title="How to download space mvc using source tree?" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
