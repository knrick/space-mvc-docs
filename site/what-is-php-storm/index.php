...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0, mkdocs-material-3.1.0">
        ...
        <title>What is PHP Storm IDE? - Space MVC Framework</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="#what-is-an-code-development-ide" tabindex="1" class="md-skip">
        Skip to content
      </a>
...
<div class="md-search" data-md-component="search" role="dialog">
  ...
  <li class="md-nav__item md-nav__item--active">
    ...
    <a href="./" title="What is PHP Storm IDE?" class="md-nav__link md-nav__link--active">
      What is PHP Storm IDE?
    </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#php-storm-ide" title="PHP Storm IDE" class="md-nav__link">
    PHP Storm IDE
  </a>
        ...
        <li class="md-nav__item">
  <a href="#how-to-install-php-storm-ide" title="How to install PHP Storm IDE" class="md-nav__link">
    ...
    How to install PHP Storm IDE
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
              ...
              <!-- 
                  <a href="https://github.com/space-mvc/space-mvc/edit/master/docs/what-is-php-storm.md" title="Edit this page" class="md-icon md-content__icon">&#xE3C9;</a>
                 -->

                
                <h1 id="what-is-an-code-development-ide">What is an Code Development IDE?</h1>
<p>An integrated development environment (IDE) is a software suite that consolidates basic tools required to write and test software.</p>
<p>Developers use numerous tools throughout software code creation, building and testing. Development tools often include text editors, code libraries, compilers and test platforms. Without an IDE, a developer must select, deploy, integrate and manage all of these tools separately. An IDE brings many of those development-related tools together as a single framework, application or service. The integrated toolset is designed to simplify software development and can identify and minimize coding mistakes and typos.</p>
<p>Integrated development environments are designed to maximize programmer productivity by providing tight-knit components with similar user interfaces.
IDEs present a single program in which all development is done. This program typically provides many features for authoring, modifying, compiling, deploying and debugging software.</p>
<p>Some IDEs are dedicated to a specific programming language, allowing a feature set that most closely matches the programming paradigms of the language. However, there are many multiple-language IDEs.</p>
<h2 id="php-storm-ide">PHP Storm IDE</h2>
<p>Php storm is a very common and popularly used PHP IDE developers use everyday to developer php code</p>
<h2 id="how-to-install-php-storm-ide">How to install PHP Storm IDE</h2>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../what-is-wamp/" title="What is Wamp?" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
          ...
          <a href="../what-is-git/" title="What is Git?" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
