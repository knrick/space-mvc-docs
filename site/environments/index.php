...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0, mkdocs-material-3.1.0">
        ...
        <title>Environments - Space MVC Framework</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="#environment-configuration" tabindex="1" class="md-skip">
        Skip to content
      </a>
...
<div class="md-search" data-md-component="search" role="dialog">
  ...
  <li class="md-nav__item md-nav__item--active">
    ...
    <a href="./" title="Environments" class="md-nav__link md-nav__link--active">
      Environments
    </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#environment-configuration" title="Environment Configuration" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#environment-variable-types" title="Environment Variable Types" class="md-nav__link">
    Environment Variable Types
          ...
          <li class="md-nav__item">
  <a href="#retrieving-environment-configuration" title="Retrieving Environment Configuration" class="md-nav__link">
    Retrieving Environment Configuration
          ...
          <li class="md-nav__item">
  <a href="#determining-the-current-environment" title="Determining The Current Environment" class="md-nav__link">
    ...
    Determining The Current Environment
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
              ...
              <!-- 
                  <a href="https://github.com/space-mvc/space-mvc/edit/master/docs/environments.md" title="Edit this page" class="md-icon md-content__icon">&#xE3C9;</a>
                 -->
...
<p>To make this a cinch, Space MVC utilizes the <a href="https://github.com/vlucas/phpdotenv">DotEnv</a> PHP library
        ...
        file will automatically be renamed to .env. Otherwise, you should rename the file manually.</p>
...
<p>If you are developing with a team, you may wish to continue including a .env.example file
        ...
        file when running PHPUnit tests or executing Artisan commands with the --env=testing option.</p>
<p>Any variable in your .env file can be overridden by external environment variables such as server-level or system-level environment variables.</p>
...
<pre><code class="php">APP_NAME=&quot;My Application&quot;
</code></pre>
...
<pre><code class="php">'debug' =&gt; env('APP_DEBUG', false),
</code></pre>
...
<a name="determining-the-current-environment"></a></p>
...
<pre><code class="php">if (App::environment('local')) {
...
<p>The current application environment detection can be overridden by a server-level APP_ENV environment variable. This can
...
<a name="hiding-environment-variables-from-debug"></a></p>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../space-cli/" title="Space CLI Tool" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
