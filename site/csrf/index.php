...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0, mkdocs-material-3.1.0">
        ...
        <title>CSRF Protection - Space MVC Framework</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="#csrf-protection" tabindex="1" class="md-skip">
        Skip to content
      </a>
  ...
  <a href="#introduction" title="Introduction" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#csrf-tokens-javascript" title="CSRF Tokens &amp; JavaScript" class="md-nav__link">
    CSRF Tokens &amp; JavaScript
        ...
        <li class="md-nav__item">
  <a href="#excluding-uris-from-csrf-protection" title="Excluding URIs From CSRF Protection" class="md-nav__link">
    Excluding URIs From CSRF Protection
        ...
        <li class="md-nav__item">
  <a href="#x-csrf-token" title="X-CSRF-TOKEN" class="md-nav__link">
    X-CSRF-TOKEN
  </a>
        ...
        <li class="md-nav__item">
  <a href="#x-xsrf-token" title="X-XSRF-TOKEN" class="md-nav__link">
    X-XSRF-TOKEN
  </a>
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
              ...
              <!-- 
                  <a href="https://github.com/space-mvc/space-mvc/edit/master/docs/csrf.md" title="Edit this page" class="md-icon md-content__icon">&#xE3C9;</a>
                 -->
...
<h2 id="introduction"><a href="#csrf-introduction">Introduction</a></h2>
<p>Space MVC makes it easy to protect your application from <a href="https://en.wikipedia.org/wiki/Cross-site_request_forgery">cross-site request forgery</a> (CSRF) attacks. Cross-site request forgeries are a type of malicious exploit whereby unauthorized commands are performed on behalf of an authenticated user.
...
Anytime you define a HTML form in your application, you should include a hidden CSRF token field in the form so that the CSRF protection middleware can validate the request. You may use the @csrf Blade directive to generate the token field:</p>
...
<a name="csrf-excluding-uris"></a></p>
<h2 id="excluding-uris-from-csrf-protection"><a href="#csrf-excluding-uris">Excluding URIs From CSRF Protection</a></h2>
...
Typically, you should place these kinds of routes outside of the web middleware group that the RouteServiceProvider applies to all routes in the routes/web.php file. However, you may also exclude the routes by adding their URIs to the $except property of the VerifyCsrfToken middleware:</p>
...
<p>The CSRF middleware is automatically disabled when <a href="/docs/5.7/testing">running tests</a>.
<a name="csrf-x-csrf-token"></a></p>
<h2 id="x-csrf-token"><a href="#csrf-x-csrf-token">X-CSRF-TOKEN</a></h2>
...
<p>By default, the resources/js/bootstrap.js file registers the value of the csrf-token meta tag with the Axios HTTP library. If you are not using this library, you will need to manually configure this behavior for your application.
<a name="csrf-x-xsrf-token"></a></p>
<h2 id="x-xsrf-token"><a href="#csrf-x-xsrf-token">X-XSRF-TOKEN</a></h2>
<p>Space MVC stores the current CSRF token in a XSRF-TOKEN cookie that is included with each response generated by the framework. You can use the cookie value to set the X-XSRF-TOKEN request header.
...
<p><a name="csrf-introduction"></a></p>
<h2 id="introduction_1"><a href="#csrf-introduction">Introduction</a></h2>
<p>Space MVC makes it easy to protect your application from <a href="https://en.wikipedia.org/wiki/Cross-site_request_forgery">cross-site request forgery</a> (CSRF) attacks. Cross-site request forgeries are a type of malicious exploit whereby unauthorized commands are performed on behalf of an authenticated user.
Space MVC automatically generates a CSRF "token" for each active user session managed by the application. This token is used to verify that the authenticated user is the one actually making the requests to the application.
Anytime you define a HTML form in your application, you should include a hidden CSRF token field in the form so that the CSRF protection middleware can validate the request. You may use the @csrf Blade directive to generate the token field:</p>
<pre><code class="php">&lt;form method=&quot;POST&quot; action=&quot;/profile&quot;&gt;
...
<p>The VerifyCsrfToken <a href="/docs/5.7/middleware">middleware</a>, which is included in the web middleware group, will automatically verify that the token in the request input matches the token stored in the session.</p>
<h4 id="csrf-tokens-javascript_1">CSRF Tokens &amp; JavaScript</h4>
<p>When building JavaScript driven applications, it is convenient to have your JavaScript HTTP library automatically attach the CSRF token to every outgoing request. By default, the resources/js/bootstrap.js file registers the value of the csrf-token meta tag with the Axios HTTP library. If you are not using this library, you will need to manually configure this behavior for your application.
<a name="csrf-excluding-uris"></a></p>
<h2 id="excluding-uris-from-csrf-protection_1"><a href="#csrf-excluding-uris">Excluding URIs From CSRF Protection</a></h2>
<p>Sometimes you may wish to exclude a set of URIs from CSRF protection. For example, if you are using <a href="https://stripe.com">Stripe</a> to process payments and are utilizing their webhook system, you will need to exclude your Stripe webhook handler route from CSRF protection since Stripe will not know what CSRF token to send to your routes.
Typically, you should place these kinds of routes outside of the web middleware group that the RouteServiceProvider applies to all routes in the routes/web.php file. However, you may also exclude the routes by adding their URIs to the $except property of the VerifyCsrfToken middleware:</p>
<pre><code class="php">&lt;?php
...
<p>The CSRF middleware is automatically disabled when <a href="/docs/5.7/testing">running tests</a>.
<a name="csrf-x-csrf-token"></a></p>
<h2 id="x-csrf-token_1"><a href="#csrf-x-csrf-token">X-CSRF-TOKEN</a></h2>
<p>In addition to checking for the CSRF token as a POST parameter, the VerifyCsrfToken middleware will also check for the X-CSRF-TOKEN request header. You could, for example, store the token in a HTML meta tag:</p>
<pre><code class="php">&lt;meta name=&quot;csrf-token&quot; content=&quot;{{ csrf_token() }}&quot;&gt;
</code></pre>
...
<p>By default, the resources/js/bootstrap.js file registers the value of the csrf-token meta tag with the Axios HTTP library. If you are not using this library, you will need to manually configure this behavior for your application.
<a name="csrf-x-xsrf-token"></a></p>
<h2 id="x-xsrf-token_1"><a href="#csrf-x-xsrf-token">X-XSRF-TOKEN</a></h2>
<p>Space MVC stores the current CSRF token in a XSRF-TOKEN cookie that is included with each response generated by the framework. You can use the cookie value to set the X-XSRF-TOKEN request header.
This cookie is primarily sent as a convenience since some JavaScript frameworks and libraries, like Angular and Axios, automatically place its value in the X-XSRF-TOKEN header.</p>
