...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0, mkdocs-material-3.1.0">
        ...
        <title>What is Git? - Space MVC Framework</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="#what-is-git" tabindex="1" class="md-skip">
        Skip to content
      </a>
...
<div class="md-search" data-md-component="search" role="dialog">
  ...
  <li class="md-nav__item md-nav__item--active">
    ...
    <a href="./" title="What is Git?" class="md-nav__link md-nav__link--active">
      What is Git?
    </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#what-is-source-tree" title="What is source tree?" class="md-nav__link">
    What is source tree?
  </a>
        ...
        <li class="md-nav__item">
  <a href="#how-to-install-source-tree" title="How to install source tree?" class="md-nav__link">
    ...
    How to install source tree?
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
              ...
              <!-- 
                  <a href="https://github.com/space-mvc/space-mvc/edit/master/docs/what-is-git.md" title="Edit this page" class="md-icon md-content__icon">&#xE3C9;</a>
                 -->

                
                <h1 id="what-is-git">What is Git?</h1>
<p>By far, the most widely used modern development code backup and history version control system in the world today is Git. Git is a mature, actively
...
<p>In short Git is used to backup a copy of your website code online in its original source code state. You can setup git
    ...
    You can also allow multiple developers to work from your github repositories (project backups).</p>
...
<h2 id="what-is-source-tree">What is source tree?</h2>
<p>In general when using the default git commands this is usually done via the command line or terminal,
yet this can be harder to learn for first time users. There programs such as source tree available which offer a
graphical user interface to make git easier to use.</p>
<h2 id="how-to-install-source-tree">How to install source tree?</h2>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../what-is-php-storm/" title="What is PHP Storm IDE?" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
          ...
          <a href="../github-multiple-users/" title="How to use git in a Dev Team?" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
