...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0, mkdocs-material-3.1.0">
        ...
        <title>Middleware - Space MVC Framework</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="#middleware" tabindex="1" class="md-skip">
        Skip to content
      </a>
...
<nav class="md-nav md-nav--secondary">
  ...
  <a href="#introduction" title="Introduction" class="md-nav__link">
    Introduction
        ...
        <li class="md-nav__item">
  <a href="#defining-middleware" title="Defining Middleware" class="md-nav__link">
    Defining Middleware
  </a>
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#before-after-middleware" title="Before &amp; After Middleware" class="md-nav__link">
    Before &amp; After Middleware
        ...
        <li class="md-nav__item">
  <a href="#registering-middleware" title="Registering Middleware" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#global-middleware" title="Global Middleware" class="md-nav__link">
    Global Middleware
  </a>
          ...
          <li class="md-nav__item">
  <a href="#assigning-middleware-to-routes" title="Assigning Middleware To Routes" class="md-nav__link">
    Assigning Middleware To Routes
          ...
          <li class="md-nav__item">
  <a href="#middleware-groups" title="Middleware Groups" class="md-nav__link">
    Middleware Groups
  </a>
        ...
        <li class="md-nav__item">
  <a href="#middleware-parameters" title="Middleware Parameters" class="md-nav__link">
    Middleware Parameters
        ...
        <li class="md-nav__item">
  <a href="#terminable-middleware" title="Terminable Middleware" class="md-nav__link">
    Terminable Middleware
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
              ...
              <!-- 
                  <a href="https://github.com/space-mvc/space-mvc/edit/master/docs/middleware.md" title="Edit this page" class="md-icon md-content__icon">&#xE3C9;</a>
                 -->
...
<a name="defining-middleware"></a></p>
...
<pre><code class="php">php artisan make:middleware CheckAge
</code></pre>
...
All middleware are resolved via the <a href="/docs/5.7/container">service container</a>, so you may type-hint any dependencies you need within a middleware's constructor.</p>
...
<h2 id="registering-middleware"><a href="#registering-middleware">Registering Middleware</a></h2>
<p><a name="global-middleware"></a></p>
<h3 id="global-middleware">Global Middleware</h3>
<p>If you want a middleware to run during every HTTP request to your application, list the middleware class in the $middleware property of your app/Http/Kernel.php class.
<a name="assigning-middleware-to-routes"></a></p>
...
<pre><code class="php">// Within App\Http\Kernel Class...
...
<pre><code class="php">Route::get('admin/profile', function () {
    //
})-&gt;middleware('auth');
</code></pre>
...
<pre><code class="php">use App\Http\Middleware\CheckAge;
...
Out of the box, Space MVC comes with web and api middleware groups that contain common middleware you may want to apply to your web UI and API routes:</p>
<pre><code class="php">/**
...
<a name="middleware-parameters"></a></p>
<h2 id="middleware-parameters"><a href="#middleware-parameters">Middleware Parameters</a></h2>
<p>Middleware can also receive additional parameters. For example, if your application needs to verify that the authenticated user has a given "role" before performing a given action, you could create a CheckRole middleware that receives a role name as an additional argument.
Additional middleware parameters will be passed to the middleware after the $next argument:</p>
<pre><code class="php">&lt;?php
...
<p>The terminate method should receive both the request and the response. Once you have defined a terminable middleware, you should add it to the list of route or global middleware in the app/Http/Kernel.php file.
